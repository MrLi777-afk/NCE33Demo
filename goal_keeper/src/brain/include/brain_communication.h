...
public:
    ...
    std::map<int, TeammateBallInfo> _teammate_ball_info_map;//gao
    std::mutex _teammate_ball_info_mutex;//gao
...
private:
    ...
    sockaddr_in _saddr;
    static constexpr int BROADCAST_DISCOVERY_INTERVAL_MS = 200;
