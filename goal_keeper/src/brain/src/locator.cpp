...
// 初始化定位器，设置场地参数、最小标记点数、残差容忍度和mu偏移量
...
// 主定位流程：输入观测标志点，输出定位结果（位置、朝向、误差等）
